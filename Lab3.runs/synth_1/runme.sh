...
HD_PWD='/ad/eng/users/h/h/hhn/Downloads/Lab3_ver3/Lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wrap_around_led.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wrap_around_led.tcl
