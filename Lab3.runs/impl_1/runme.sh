...
HD_PWD='/ad/eng/users/h/h/hhn/Downloads/Lab3_ver3/Lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log wrap_around_led.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source wrap_around_led.tcl -notrace
